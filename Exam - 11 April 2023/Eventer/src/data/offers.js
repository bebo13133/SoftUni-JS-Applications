...
const endpoint={
    album: '/data/events?sortBy=_createdOn%20desc',
    byId: '/data/events/',
...
export async function createOffer(album){
    return await post('/data/events',album) // Преправих адреса само зарди задачата - ориганалният вариант е return await post(endpoint.book,book)
}
